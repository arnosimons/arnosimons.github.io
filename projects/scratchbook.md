      ...
      <div class="panel panel-default">
        ...
        <div class="card" style="margin-bottom: 10px;">
          <div class="card-header">
            <a class="btn" data-bs-toggle="collapse" href="#collapse1" style="font-size: 18px; font-weight: 500;">The Library of Scratches</a>
          </div>
          <div id="collapse1" class="collapse in">
            <div class="card-body" style="overflow-x:auto;">
              <p>Welcome to the library of scratches, currently holding over &#128171; 60K scratches &#128194;</p>
