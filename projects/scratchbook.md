...
<body style="background-color:#F8F8F8;">
  <header style="background-color:rgb(33, 37, 41)">
    <div class="container-md p-2.5 bg-dark text-white">
      ...
      <p>Based on a free library of scratches currently including over &#128171; 60K scratches &#128194;</p>
        ...
        <div class="card" style="margin-bottom: 10px;">
          ...
          <div id="collapse1" class="collapse in">
            <div class="card-body" style="overflow-x:auto;">
              <p style="font-size: 16px;">Welcome to the Free Library of Scratches!</p>
              ...
              <p>The following <strong>table</strong> lists and classifies all available scratches. The meaning of the columns is explained below.</p>
